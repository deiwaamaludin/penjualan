			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						<h2><?php foreach ($nama_merk->result_array() as $value) {
							echo $value['nama_merk'];
						}
						?>
						...
						<?php
						if ($produk_merk->num_rows()>0) {

							foreach ($produk_merk->result_array() as $value) { 
							$no;
							?>
						<div class="col-sm-4">
