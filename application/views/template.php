...
<body class="page-header-fixed">
  ...
  <div class="header navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="navbar-inner">
      <div class="container-fluid">
        <!-- BEGIN LOGO -->
        <a class="merk" href="<?php echo base_url();?>adminweb/home">
          <?php
        ...
        <li class="dropdown" id="header_inbox_bar">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li class="external">
                <a href="<?php echo base_url();?>adminweb/buku_tamu">Lihat semua pesan <i class="m-icon-swapright"></i></a>
              </li>
            </ul>
          </li>
          ...
          <li class="dropdown" id="header_inbox_bar">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li class="external">
                <a href="<?php echo base_url();?>adminweb/transaksi">Tampil semua pesan <i class="m-icon-swapright"></i></a>
              </li>
            </ul>
          </li>
    ...
    <div class="page-sidebar nav-collapse collapse">
      ...
      <ul class="page-sidebar-menu">
        ...
        <li >
          ...
          <ul class="sub-menu">
             <li >
              <a href="<?php echo base_url();?>adminweb/merk">
              Merk</a>
            </li>
            <li >
  ...
  <div class="footer">
    <div class="footer-inner">
      2019 &copy; Spare Part Vespa - Admin Dashboard.
    </div>
