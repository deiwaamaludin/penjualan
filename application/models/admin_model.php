...
class admin_model extends CI_Model {
	...
	function MerkSama($nama_merk) {
		return $this->db->query("select * from tbl_merk where binary(nama_merk)='$nama_merk' ");
	}

	function MerkSimpan($nama_merk) {
		return $this->db->query("insert into tbl_merk values('','$nama_merk')");
	}

	function DeleteMerk($id_merk) {
		return $this->db->query("delete from tbl_merk where id_merk='$id_merk'");
	}

	function GetEditMerk($id_merk) {
		return $this->db->query("select * from tbl_merk where id_merk='$id_merk'");
	}
	function MerkUpdate($id_merk,$nama_merk) {
		return $this->db->query("update tbl_merk set nama_merk='$nama_merk' where id_merk='$id_merk'");
	}
	//Akhir Merk
	...
	function GetProduk() {
		return $this->db->query("select a.*,b.nama_merk,c.nama_kategori from tbl_produk a join tbl_merk b on a.merk_id=b.id_merk join tbl_kategori c on a.kategori_id=c.id_kategori order by a.id_produk desc");
	}
