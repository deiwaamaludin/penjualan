							...
							<div class="portlet-body form">
								...
								<div id="form_sample_2" class="form-horizontal">
									...
									<div class="control-group">
												...
												<div class="controls">
													<select id="select2_sample1" name="merk_id" class="span6 select2">
														<option value=""></option>
														<?php
														foreach ($data_merk->result_array() as $tampil) { 
															if ($merk_id==$tampil['id_merk']) { ?>
															<option value="<?php echo $tampil['id_merk'];?>" selected="selected"><?php echo $tampil['nama_merk'];?></option>
															<?php
															}
															else { ?>
															<option value="<?php echo $tampil['id_merk'];?>"><?php echo $tampil['nama_merk'];?></option>
															<?php
															}
